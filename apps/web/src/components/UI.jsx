...
export function CLIPill({ score, size = 'md', showScore = true, className }) {
  ...
  return (
    <span
      className={cn('cli-pill inline-flex items-center rounded-full shrink-0', dimensions, className)}
      data-band={band}
